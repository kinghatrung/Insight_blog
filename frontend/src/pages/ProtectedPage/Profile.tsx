...
import { Flex, Avatar, Button, Typography, Tabs, Col, Row, Modal, Skeleton, Grid } from 'antd'
...
function Profile() {
  ...
  return (
    <div>
      <Row gutter={[24, 24]} justify={screens.lg ? 'start' : 'center'} align='middle'>
        <Col>
          {loadingAuthor ? (
            <Skeleton.Avatar
              shape='circle'
              size={228}
              style={{ marginBottom: 32, backgroundColor: '#1f2937' }}
              active
            />
          ) : (
            <Avatar
