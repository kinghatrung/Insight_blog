    ...
    },
    {
      ...
      render: (_, record) => (
        <Flex gap={8} align='center'>
          ...
          />
          <Button style={{ padding: 3 }} type='link' onClick={() => setEditingUser(record)}>
            <EditOutlined />
          </Button>
        </Flex>
      )
    ...
    <>
      ...
      >
        <ProForm
          ...
          onFinish={(value: EditAvatarFormValues) => {
            if (!editingUser) return
            handleEditAvatar(editingUser._id, value, editingUser.avatarId)
          }}
          submitter={{
            searchConfig: {
              submitText: 'Cập nhập',
